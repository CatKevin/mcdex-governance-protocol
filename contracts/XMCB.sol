...
contract XMCB {
    ...
    function _mint(address account, uint256 rawAmount) internal virtual {
        uint96 amount = safe96(rawAmount, "XMCB::mint: amount exceeds 96 bits");
        _balances[account] = add96(_balances[account], amount, "XMCB::mint: mint amount overflows");
        _totalSupply = add96(_totalSupply, amount, "XMCB::mint: mint amount overflows");

        _moveDelegates(address(0), delegates[account], amount);
    }

    function _burn(address account, uint256 rawAmount) internal virtual {
        uint96 amount = safe96(rawAmount, "XMCB::burn: amount exceeds 96 bits");
        _balances[account] = sub96(_balances[account], amount, "XMCB::burn: burn amount overflows");
        _totalSupply = sub96(_totalSupply, amount, "XMCB::burn: burn amount overflows");
    ...
    function _moveDelegates(
        ...
        if (srcRep != dstRep && amount > 0) {
            if (srcRep != address(0)) {
                ...
                uint96 srcRepNew =
                    sub96(srcRepOld, amount, "XMCB::_moveVotes: vote amount underflows");
            ...
            if (dstRep != address(0)) {
                ...
                uint96 dstRepNew =
                    add96(dstRepOld, amount, "XMCB::_moveVotes: vote amount overflows");
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(block.number, "XMCB::_writeCheckpoint: block number exceeds 32 bits");
