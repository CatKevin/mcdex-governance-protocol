...
export class L1Bridge {
    ...
    constructor(erc20BridgeAddress: string, l1Signer: Signer) {
        ...
        this.l1Tokens = {}
        this.address = erc20BridgeAddress
    ...
    public async depositETH(
        ...
        return inbox.sendL1FundedContractTransaction(
            maxGas,
            BigNumber.from(0),
            address,
            '0x',
    ...
    public async getInbox() {
        ...
        const inboxAddress = '0xA4d796Ad4e79aFB703340a596AEd88f8a5924183';// await this.ethERC20Bridge.inbox()
